...
public class XiaomiApiEngine implements InferenceEngine {

    private static final String TAG = "XiaomiApiEngine";
    ...
    @Override
    public String getCode() { return "xiaomi"; }

    @Override
    public String getDisplayName() { return "小米 mimo-v2.5"; }
    ...
    public String generate(List<Message> messages, float temperature, int maxTokens,
        ...
        try {
            ...
            Log.i(TAG, "Calling Xiaomi API with " + messages.size() + " messages");
            AppLog.i(TAG, "调用小米模型 API，消息数: " + messages.size());
    ...
    private String getApiKey() {
        // This will be set from ChatViewModel before calling generate
        // For now, read from a static field that ChatViewModel sets
        return apiKeyHolder;
    }

    // Static holder for API key, set by ChatViewModel before calling generate
